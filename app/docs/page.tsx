...
export default function Home() {
  return (
    <main className="mx-auto max-w-3xl text-[#868794]">
      <h1 className="mb-6 text-4xl font-bold text-white">Welcome to Our Docs</h1>
      <p className="mb-4">
        This is a gorgeous minimal documentation site built with Next.js, Tailwind CSS, and shadcn/ui components.
      </p>
      <h2 className="mb-4 mt-8 text-2xl font-semibold text-white">Features</h2>
      ...
      <h2 className="mb-4 mt-8 text-2xl font-semibold text-white">Getting Started</h2>
      <p className="mb-4">
      ...
      <ul className="mb-4 list-inside list-disc space-y-1">
        <li>
          <strong className="text-white">Getting Started</strong>: Learn how to install and set up our library
        </li>
        <li>
          <strong className="text-white">Components</strong>: Explore the available components and how to use them
        </li>
        <li>
          <strong className="text-white">API Reference</strong>: Detailed information about our API and its methods
        </li>
      </ul>
      <p className="mb-4">
        If you have any questions or need further assistance, don&apos;t hesitate to reach out to our support team.
      </p>
      <h2 className="mb-4 mt-8 text-2xl font-semibold text-white">Contributing</h2>
      <p className="mb-4">
